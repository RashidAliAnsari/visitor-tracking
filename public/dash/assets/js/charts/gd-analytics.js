...
// console.log(byDevice[0]);

!(function (NioApp, $) {
    "use strict";

    console.log(JSON.parse(byConutry));
    console.log('byConutry from chart');
    // Vector Map
    var worldMap = {
        map: 'world_en',
    ...
    var deviceStatusData = {
        ...
        datasets : [{
            ...
            // data: [84.5, 14.2, 1.3]
            data: [JSON.parse(byDevice).byDeviceDesktop, JSON.parse(byDevice).byDeviceMobile, JSON.parse(byDevice).byDeviceTablet]
        }]
    };
    ...
    console.log(JSON.parse(trafficChannel));
    console.log('trafficChannel from chart');
    ...
    var OrganicSearchData = {
        ...
        datasets : [{
            ...
            data: [JSON.parse(trafficChannel).google]
            // data: [259,54,65,878,54,43,6546,8768,876,43]
        }]
    };
    ...
    var SocialMediaData = {
        ...
        datasets : [{
            ...
            data: [JSON.parse(trafficChannel).facebook]
        }]
    };
    ...
    var ReferralsData = {
        ...
        datasets : [{
            ...
            data: [JSON.parse(trafficChannel).adf]
        }]
    };
    ...
    var OthersData = {
        ...
        datasets : [{
            ...
            data: [JSON.parse(trafficChannel).others]
        }]
    };

    console.log(JSON.parse(marketingPerformance));
    console.log('marketingPerformance from chart');
    ...
    var BounceRateData = {
        ...
        datasets : [{
            ...
            data: [JSON.parse(marketingPerformance).bounceRate]
        }]
    };
    ...
    var PageviewsData = {
        ...
        datasets : [{
            ...
            // data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
            data: [JSON.parse(marketingPerformance).engagement]
        }]
    };
    ...
    var NewUsersData = {
        ...
        datasets : [{
            ...
            background : NioApp.hexRGB('#798bff',.25),
            // data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
            data: [JSON.parse(marketingPerformance).newViewers]
        }]
    };
    ...
    var TimeOnSiteData = {
        ...
        datasets : [{
            ...
            background : NioApp.hexRGB('#9a89ff',.25),
            // data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
            data: [JSON.parse(marketingPerformance).retention]
        }]
    };
    ...
    console.log(JSON.parse(reachSummary).daily);
    console.log('reachSummary from chart');
    ...
    var analyticAuData = {
        ...
        datasets : [{
            ...
            color : "#9cabff",
            background : "#9cabff",
            data: [JSON.parse(reachSummary).daily]
        }]
    };
    ...
    console.log(JSON.parse(marketingOverview));
    console.log('marketingOverview from chart');
    ...
    var analyticOvData = {
        ...
        datasets : [{
            ...
            data: [JSON.parse(marketingOverview).impressions]
        },{
            label : "Current Month",
            color : "#798bff",
            dash : 0,
            ...
            data: [JSON.parse(marketingOverview).reach]
        }]
    };
